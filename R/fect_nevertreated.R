  ...
  if (method == "ife") {
    ...
    if (CV == TRUE) {
        ...
        if (r.max == 0) {
            ...
            ## criterion = "pc": the r with the lowest PC (tracked in the loop
            ## as r.pc). The selections above use the MSPE family. The final
            ## fit below re-estimates the model at r.cv.
