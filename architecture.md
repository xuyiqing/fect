...
> Generated by scribe for run `redraw-arch-20260314-230628` on 2026-03-14.
...
### R-side Layers Overview

```mermaid
%%{init: {'theme': 'neutral'}}%%
graph TD
    L1["API Layer (5 modules)"]
    L2["Core Estimators (5)"]
    L3["Inference & Valid. (6)"]
    L4["Output & Viz (6)"]
    L5["Utilities (3)"]
    L6["C++ Backend (6)"]
...
> Subgraphs are stacked vertically by layer. No nodes changed in this run.

The following diagram expands the R-side modules within each layer.
...
graph TD
    subgraph API["API Layer"]
        direction TB
        A1["default.R"] ~~~ A2["interFE.R"] ~~~ A3["did_wrapper.R"]
        A4["fect_mspe.R"] ~~~ A5["fect_sens.R"]
        A3 ~~~ A4
    end

    subgraph Estimators["Core Estimators"]
        direction TB
        E1["fe.R"] ~~~ E2["cfe.R"] ~~~ E3["mc.R"]
        E4["fect_gsynth.R"] ~~~ E5["polynomial.R"]
        E3 ~~~ E4
    end

    subgraph Inference["Inference & Validation"]
        direction TB
        I1["boot.R"] ~~~ I2["cv.R"] ~~~ I3["cv_binary.R"]
        I4["fittest.R"] ~~~ I5["diagtest.R"] ~~~ I6["permutation.R"]
        I3 ~~~ I4
    end

    subgraph Output["Output & Visualization"]
        direction TB
        O1["plot.R"] ~~~ O2["print.R"] ~~~ O3["esplot.R"]
        O4["effect.R"] ~~~ O5["cumu.R"] ~~~ O6["plot_return.R"]
        O3 ~~~ O4
    end

    subgraph Utils["Utilities"]
        direction TB
        U1["support.R"] ~~~ U2["getcohort.R"] ~~~ U3["RcppExports.R"]
    end
...
The following diagram details the C++ backend modules.
...
graph TD
    subgraph Cpp["C++ Backend"]
        direction TB
        C1["ife.cpp — IFE solver"] ~~~ C2["cfe.cpp — CFE solver"] ~~~ C3["mc.cpp — MC solver"]
        C4["fe_sub.cpp — FE iter"] ~~~ C5["auxiliary.cpp — helpers"] ~~~ C6["binary_*.cpp — probit"]
        C3 ~~~ C4
    end
```
...
The following diagram traces how each estimator dispatches to C++ solvers.
