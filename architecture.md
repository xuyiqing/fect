...
> Generated by scribe for run `REQ-cfe-cv-rselect-001` on 2026-03-16. Previous: `redraw-arch-20260315` (2026-03-15).
...
| `tests/testthat/` | Tests | Test suite: basic FE/IFE/CFE simulations, staggered designs, normalization, plots, edge cases, DID wrapper, sensitivity | (test) | **yes** |
