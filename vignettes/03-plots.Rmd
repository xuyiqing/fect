...
We can change the color of the lines in this plot using `color`, which sets the color of the main line, and `counterfactual.color`, which sets the color of the counterfactual line. Additionally, we can add an outline to the CIs with `ci.outline = TRUE`.
