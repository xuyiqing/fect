...
-   [Chapter @sec-diagnostics]\
    Diagnostic tests: placebo, pre-trend (F test and equivalence), leave-one-out, carryover, and cumulative effects.

-   [Chapter @sec-model-selection]\
    Cross-validation framework, the `cv.method` parameter, scoring criteria, and post-hoc model comparison via `fect_mspe()`.
