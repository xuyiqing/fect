...
-   [Chapter @sec-fect]\
    The fixed effects counterfactual estimator (FEct), including estimation, basic inference, and the `group.fe` argument for sub-group treatment (e.g., counties nested in states with a state-level policy).
...
-   Jinwen Wu (PhD Student at Yale University)
-   [Rivka Lipkovitz](https://rivka.me/) (Undergraduate at MIT)
-   [Anton Strezhnev](https://www.antonstrezhnev.com/) (Assistant Professor at the University of Wisconsin--Madison; contributed the double leave-one-out pre-trend placebos, `dloo`)
