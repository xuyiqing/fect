...
We provide several methods for researchers to explore heterogeneous treatment effects (HTE). These work with any method; here we demonstrate with the FE estimator using `sim_base`. R script used in this chapter can be downloaded [here](https://raw.githubusercontent.com/xuyiqing/fect/dev/vignettes/rscript/05-hte.R).
