...
We provide several methods for researchers to explore heterogeneous treatment effects (HTE). These work with any method; here we demonstrate with the FE estimator using `sim_base`.
