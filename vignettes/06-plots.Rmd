...
In this chapter, we explore visualization options available in the **fect** package. Plots are organized by `type`, from the default gap plot through diagnostic plots (equivalence, placebo, carryover), cumulative effects, heterogeneity plots, and special-purpose displays. We begin with shared parameter conventions, then work through each plot type progressively.
...
## Carryover Test (`type = "exit"`) {#sec-exit}
...
### Counterfactual plot (`type = "counterfactual"`)
...
### Factors and loadings (`type = "factors"`, `type = "loadings"`)
