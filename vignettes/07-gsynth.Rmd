...
Since `sim_gsynth` follows a pure IFE data generating process, gsynth and CFE with nevertreated should produce similar MSPE, confirming that the additional CFE structure neither helps nor hurts when it is not needed.
