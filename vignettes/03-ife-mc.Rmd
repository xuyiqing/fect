# Low-Rank Factor Methods {#sec-ife-mc}
...
```{r exit_ife, eval = TRUE, cache = TRUE, warning = FALSE, fig.width = 6, fig.height = 4.5}
plot(out.ife, type = "exit", ylim = c(-2.5,4.5), main = "Exit Plot (IFE)")
```

```{r exit_mc, eval = TRUE, cache = TRUE, warning = FALSE, fig.width = 6, fig.height = 4.5}
