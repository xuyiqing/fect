...
`r.cv.rolling()` is currently supported only for `method = "ife"` with `time.component.from = "notyettreated"` (the only fect path that populates `Y.ct.full` at masked control positions). Other configurations error with a migration message.
