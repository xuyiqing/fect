...
* For jackknife fits, `att.cumu()`, `effect()` and `estimand("att.cumu")` now give the jackknife standard error of the cumulative ATT, computed as for the fit's own standard errors, with a normal interval. `att.cumu()` reported one about $\sqrt{N-1}$ times too small for $N$ units, and `effect()` one about 1% too large.
