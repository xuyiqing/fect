...
| GitHub (`dev`) | 2.4.6 | in development | Adds `dloo` placebos, the LOO equivalence-test window fix, and cross-validation of the number of factors by default for `method = "ife"` |
