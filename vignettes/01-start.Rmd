...
-   `simgsynth` & `turnout`: Based on @Xu2017. Used in [Chapter @sec-gsynth] to demonstrate the never-treated estimation regime (formerly the standalone **gsynth** package, now unified into **fect**).
