...
bootstrap), ggplot2 and GGally (plots), mvtnorm (parametric errors). Version 2.4.6 (unreleased).
...
## Contracts introduced or tightened in 2.4.6
...
- `dloo` (R/dloo.R, 2.4.6) is a closed-form overlay on the in-sample fit; it is not part of this run's
